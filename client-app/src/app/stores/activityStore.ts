...
export default class ActivityStore {
    ...
    updateActivity = async (activity: ActivityFormValues) => {
        ...
        try {
            ...
            runInAction(() => {
                if(activity.id) {
                    let updatedActiviy = {...this.getActivity(activity.id), ...activity}
                    this.activityRegistry.set(activity.id, updatedActiviy as Activity);
                    this.selectedActivity = updatedActiviy as Activity;
                }
